function [listo]=generarOutputTotal(mejorANN,mejorENN,tipoNormalizacion)
...
disp('annDesnormalizada')
size(annDesnormalizada)
...
disp('ennDesnormalizada')
size(ennDesnormalizada)
